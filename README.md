...
テスト対象のPJ：生産ライン管理機器のテスト(1ヶ月)<br>

2. システムテスト、リリース後のテスト<br>
テスト対象のPJ：電子書籍サービスのスマートフォンアプリ&WEBサービス(5ヶ月)<br>
テスト対象のPJ：クリエイター向けWEBサービス(8ヶ月)<br>
テスト対象のPJ：スタンプ作成スマートフォンアプリケーション(現在：1年１ヶ月)<br>
...
### ソフトウェアテスト技術関連
- 資格勉強<br>
JSTQB認定テスト技術者資格 Advanced Level テストマネージャー
